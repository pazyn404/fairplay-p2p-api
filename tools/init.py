...
user_signing_key = SigningKey.generate(curve=SECP256k1, hashfunc=sha256)
user_verifying_key = user_signing_key.get_verifying_key()
...
with open("../host/keys/user_private_key.der", "wb") as f:
    f.write(user_signing_key.to_der())
with open("../host/keys/user_public_key.der", "wb") as f:
    f.write(user_verifying_key.to_der())
